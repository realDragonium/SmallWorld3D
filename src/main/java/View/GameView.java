...
public class GameView {
    ...
    @FXML
    private Group mapGroup, buttonGroup, playerGroup, roundGroup, turnGroup, shopGroup, timerGroup, vervalGroup, diceGroup, redeployingGroup, infoGroup, smallworldGroup, attackGroup;
    @FXML
